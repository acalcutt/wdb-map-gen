...
[ ! -f data/water-polygons-split-3857.zip ] && wget http://data.openstreetmapdata.com/water-polygons-split-3857.zip -P data
[ -f data/water-polygons-split-3857.zip ] && unzip -p data/water-polygons-split-3857.zip water-polygons-split-3857/water_polygons.shp > data/water_polygons.shp
[ -f data/water-polygons-split-3857.zip ] && unzip -p data/water-polygons-split-3857.zip water-polygons-split-3857/water_polygons.shx > data/water_polygons.shx
[ -f data/water-polygons-split-3857.zip ] && unzip -p data/water-polygons-split-3857.zip water-polygons-split-3857/water_polygons.dbf > data/water_polygons.dbf
...
shp2pgsql -s 3857 -I -g geometry data/water_polygons.shp $op_table_name > data/water_polygons.sql
